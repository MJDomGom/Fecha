...
public class FacturaViewImpl extends javax.swing.JPanel implements FacturaView {
    ...
    //CREACION DE LA NUEVA FACTURA CON FECHA
    protected void fireNuevaFacturaGesture(String identificador, Cliente cliente, String importe,String fechaPagado) throws ParseException {
        this.getController().nuevaFacturaGesture(identificador, cliente, importe,fechaPagado);
    }
    ...
    //ACTUALIZACION DE LA FECHA CON LA FECHA
    protected void fireActualizaFacturaGesture(String identificador, Cliente cliente, String importe,String fechaPagado) throws ParseException {
        this.getController().actualizaFacturaGesture(identificador, cliente, importe,fechaPagado);
    }
