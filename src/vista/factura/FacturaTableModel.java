    ...
    public Class<?> getColumnClass(int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 2:
                ...
                break;
            case 3:
                //PARA QUE SALGA EL CHECKBOX EN EL JTABLE, SE NECESITA QUE SEA DE CLASE BOOLEAN
                c = Boolean.class;
        }
        return c;
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 2:
                ...
                break;
            case 3:
                //INSERTAR EL VALOR DEL CHECKBOX DEPENDIENDO SI EXISTE LA FECHA DE LA FACTURA O NO
                value = factura.getFecha() != null;
                break;
        }
        return value;
