...
public interface FacturaController {
    ...
    void nuevaFacturaGesture(String id, Cliente cliente, String importe,String fecha)throws ParseException;
    void borraFacturaGesture(String id);
    void actualizaFacturaGesture(String id, Cliente cliente, String importe);
    void actualizaFacturaGesture(String id, Cliente cliente, String importe,String fecha) throws ParseException;
